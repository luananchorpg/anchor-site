...
export const metadata: Metadata = { title: "Pricing | Traditional Property Management | Anchor Property Group" };

export default function TraditionalPricing() {
  return (
    <div className="mx-auto max-w-5xl px-6 py-16">
      ...
      <div className="grid md:grid-cols-3 gap-4 mb-12">
        ...
        <div className="border border-black/10 rounded-xl p-6">
          ...
          <p className="text-sm text-black/40 mb-4">tenant placement, capped at $2,000</p>
          <p className="text-2xl font-bold text-black mb-0.5">$200</p>
          <p className="text-sm text-black/40 mb-6">lease renewal</p>
